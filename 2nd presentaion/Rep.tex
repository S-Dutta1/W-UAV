...
%%%%%%%%%%%%%%%%%%%%%%%%%%
\frame{\frametitle{Further Developments} 
\begin{itemize}
\item Develop a more efficient algorithm while avoiding obstacles
\item Develop a 3D model taking height into account
\item Develop a simulation using multiple obstacles and multiple false fires
\end{itemize}
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%
\end{document}